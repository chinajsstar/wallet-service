...
//	}
//
//	transfer := &Transfer{tx: ts, blocknumber: bigint, state: wtypes.Tx_state_commited}
//	return transfer, nil
//}
//
...
//				return ctx.Err()
//			default:
//				self.state = wtypes.Tx_state_commited
//				return nil
//			}
//		}
//		return nil
...
//	if self.tx == nil {
//		self.state = wtypes.Tx_state_unkown
...
//		// the second return value form bool(isPending) to block number(which Transfer store at)
...
//		self.state = wtypes.Tx_state_confirmed
//
