...
//          seed, err := btc_settings.GenSeed(256)
//
//          // Create a master private key
//          masterprv := btc_settings.MasterKey(seed)
//
...
//          childstring, err := btc_settings.StringChild(walletstring,0)
//          childaddress, err := btc_settings.StringAddress(childstring)
//
// Extended Keys
//
